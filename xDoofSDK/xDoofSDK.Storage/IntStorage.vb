...
Namespace Storage
    ''' <summary>
    ''' Initialise une nouvelle instance de la classe <see cref="IntStorage"/>.
    ''' </summary>
    Public Class IntStorage
        Dim StoreStr As List(Of String) = New List(Of String)
        Dim StoreStrValue As List(Of Integer) = New List(Of Integer)

        Public Sub New()

        End Sub
        ''' <summary>
        ''' Ajoute un item dans le stockage de <see cref="Integer"/> ainsi que ca valeur spécifié.
        ''' </summary>
        Public Sub PushItem(ByVal item As String, ByVal value As Integer)
            Try
                StoreStr.Add(item)
        ...
        End Sub
        ''' <summary>
        ''' Ajoute une <see cref="List(Of Integer)"/> dans le stockage de <see cref="Integer"/> ainsi que les valeurs spécifiés.
        ''' </summary>
        Public Sub PushItemList(ByVal item As String(), ByVal value As Integer())
            Try
        ...
        ''' </summary><returns>Retourne un <see cref="Boolean"/>, True si remplacer, False dans le cas contraire.</returns>
        Public Function ReplaceItemValue(ByVal item As String, ByVal newValue As Integer) As Boolean
            Try
                For i As Integer = 0 To StoreStr.Count - 1
        ...
        ''' </summary><returns>Retourne un <see cref="Boolean"/>, True si remplacer, False dans le cas contraire.</returns>
        Public Function ReplaceItemValueList(ByVal item As String(), ByVal newValue As Integer()) As Boolean
            Dim RetBool As Boolean
            Try
                For i As Integer = 0 To StoreStr.Count - 1
        ...
        ''' </summary><returns>Retourne un <see cref="Boolean"/>, True si remplacer, False dans le cas contraire.</returns>
        Public Function ReplaceItemWithValue(ByVal oldItem As String, ByVal newItem As String, ByVal newValue As Integer) As Boolean
            Try
                For i As Integer = 0 To StoreStr.Count - 1
                    If StoreStr(i) = oldItem Then
                        StoreStr(i) = newItem
        ...
        ''' </summary><returns>Retourne un <see cref="Boolean"/>, True si remplacer, False dans le cas contraire.</returns>
        Public Function ReplaceItemWithValueList(ByVal oldItem As String(), ByVal newItem As String(), ByVal newValue As Integer()) As Boolean
            Dim RetBool As Boolean
            Try
                For i As Integer = 0 To StoreStr.Count - 1
                    For ii As Integer = 0 To oldItem.Length - 1
        ...
        End Function
        ''' <summary>
        ''' Supprime un item dans le stockage de <see cref="Integer"/> ainsi que ca valeur.
        ...
        End Function
        ''' <summary>
        ''' Supprime tout les items dans le stockage de <see cref="Integer"/> ainsi que toutes ces valeurs associés.
        ''' </summary>
        ...
        End Sub
        ''' <summary>
        ''' Recherche un item dans le stockage de <see cref="Integer"/>.
        ...
        End Function
        ''' <summary>
        ''' Recherche un item dans le stockage de <see cref="Integer"/> et retourne ça valeur associé.
        ''' </summary><returns>Retourne la valeur <see cref="Integer"/> associé si trouvé.</returns>
        Public Function FindItemWithReturnValue(ByVal item As String) As Integer
            Try
                For i As Integer = 0 To StoreStr.Count - 1
                    If StoreStr(i) = item Then
        ...
        End Function
        ''' <summary>
        ''' Recherche un item dans le stockage de <see cref="Integer"/> et retourne l'index.
        ...
        End Function
        ''' <summary>
        ''' Recherche un item dans le stockage de <see cref="Integer"/> et retourne ca valeur associé.
        ''' </summary><returns>Retourne une <see cref="List(Of Integer)"/> des valeurs <see cref="Integer"/> associé trouvés.</returns>
        Public Function FindItemWithReturnValueList(ByVal item As String) As List(Of Integer)
        ...
        End Function
        ''' <summary>
        ''' Compte le nombre total d'éléments dans le stockage de <see cref="Integer"/>.
        ...
        End Function
        ''' <summary>
        ''' Retourne le stockage de <see cref="Integer"/>.
        ''' </summary><returns>Retourne une <see cref="List(Of Integer)"/> du stockage.</returns>
        Public Function GetStorage() As List(Of String)
            Return StoreStr
        End Function
        ''' <summary>
        ''' Retourne les valeurs du stockage de <see cref="Integer"/>.
        ''' </summary><returns>Retourne une <see cref="List(Of Integer)"/> des valeurs du stockage.</returns>
        Public Function GetStorageValue() As List(Of Integer)
        ...
        ''' </summary>
        Public Sub SetStorageValue(ByVal itemsValue As Integer())
            Try
                StoreStrValue.Clear()
        ...
        ''' </summary>
        Public Sub SetStorageWithValue(ByVal itemsList As String(), ByVal itemsValue As Integer())
            Try
                StoreStr.Clear()
                StoreStr.AddRange(itemsList)
                StoreStrValue.Clear()
