...
Namespace Storage
    ''' <summary>
    ''' Initialise une nouvelle instance de la classe <see cref="StringArrayStorage"/>.
    ''' </summary>
    Public Class StringArrayStorage
            ...
            Try
                ...
                For i As Integer = 0 To StoreStrValue.Count - 1
                    If i = StoreStrValue.Count - 1 Then
                        GetStorage += StoreStrValue(i).ToString
                    Else
                        GetStorage += StoreStrValue(i).ToString & ":@:"
                    End If
                Next
            ...
            Try
                For i As Integer = 0 To StoreStr.Count - 1
                    If StoreStr(i) = oldItem Then
                        StoreStr(i) = newItem(0) : Return True
                    End If
                Next
            Catch : Return False : End Try
            Return False
                ...
                For i As Integer = 0 To StoreStr.Count - 1
                    For ii As Integer = 0 To item.Length - 1
                        If StoreStr(i) = item(ii) Then
                            StoreStrValue(i) = newValue : RetBool = True
                        End If
                    Next
                Next
                Return RetBool
        ...
        ''' </summary><returns>Retourne le nombre total d'éléments en <see cref="String()"/>.</returns>
